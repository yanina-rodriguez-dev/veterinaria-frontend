...
function Productos() {
  return (
    <Container>
        ...
        <p className="f-text text-verde text-center fs-5">En <strong>Huellitas Center&copy;</strong>, ofrecemos una amplia variedad de productos de cuidado animal para satisfacer las necesidades de tus queridas mascotas. Nuestra tienda cuenta con una selección cuidadosamente elegida de productos de alta calidad que incluyen alimentos especializados, suplementos nutricionales, medicamentos, accesorios y productos de higiene.</p>
        <Row>
        <Col xs={12} md={4} className="mb-4">
        <Card className="p-2 m-3 h-100">
      <Card.Img variant="top" src="https://petplanetshop.com.ar/images/product_image/597/0?w=1000&h=1300&fit=contain" alt="comida para perros marca Eukanuba" />
      <Card.Body className="text-verde">
        ...
        <Col xs={12} md={4} className="mb-4">
        <Card className="p-2 m-3 h-100">
      <Card.Img variant="top" src="https://media.istockphoto.com/id/154956025/photo/dog-equipment.jpg?s=1024x1024&w=is&k=20&c=ZskDF-zIwnL1TDZGVO5cbcvHhH-CDAtIB4IErye0B1E=" alt="juguetes para animales" />
      <Card.Body className="text-verde">
        ...
        <Col xs={12} md={4} className="mb-4">
        <Card className="p-2 m-3 h-100">
      <Card.Img variant="top" src="https://petplanetshop.com.ar/images/product_image/362/0?w=1000&h=1300&fit=contain" alt="producto para pulgas de gatos"/>
      <Card.Body className="text-verde">
