    ...
    return (
        <section className="mainSection">
            ...
            <article className="contenedorServicios">
                ...
                <div className="contenedor-imagen">
                    <img className="imagenServicios" src="https://images.pexels.com/photos/9341729/pexels-photo-9341729.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Servicio_Veterinario" />
                </div>
                <div className="contenedor-imagen">
