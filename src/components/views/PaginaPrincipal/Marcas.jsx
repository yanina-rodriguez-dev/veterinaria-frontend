const Marcas = () => {
  return (
    <section className="justify-content-end flex-grow-1 pe-3">
      <div className="bg-b">
        <h2 className="text-verde text-center">
...
{
  /* <Link to={"https://www.pedigree.com.ar/"}> */
}
{
  /* <Link to={"https://www.eukanuba.com/ar"}> */
}
{
  /* <Link to={"https://www.purina.com.ar/home"}> */
}
{
  /* <Link to={"https://www.whiskas.com.ar/"}> */
}
{
  /* <Link to={"https://www.nutrique.com.ar/conocenutrique"}> */
}
{
  /* <Link to={"https://www.royalcanin.com/ar"}> */
}
